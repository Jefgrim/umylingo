...
return [
    'analyzers' => ['*'],
    'exclude_analyzers' => [
        // Exclude file permissions check on Windows (not applicable)
    ...
    // Set a reachable URL for header checks (login preferred).
    'guest_url' => env('ENLIGHTN_GUEST_URL', '/login'),
    // Guzzle options for header checks (disable SSL verification for self-signed certs)
    'guzzle_options' => [
        'verify' => false,
    ],
    'dont_report' => [],
