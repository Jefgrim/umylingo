        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <p class="fw-bold mb-2">Our Features</p>
                    <h3 class="fw-bold">What we offer for you</h3>
                </div>
            </div>
            <div class="py-5 p-lg-5">
                <div class="row row-cols-1 row-cols-md-2 mx-auto" style="max-width: 900px;">
                    <div class="col mb-5">
                        <div class="card shadow-sm" style="background-color: #0c5894;">
                            <div class="card-body px-4 py-5 px-md-5">
                                <div class="bs-icon-lg d-flex justify-content-center align-items-center mb-3 bs-icon"
                                    style="top: 1rem;right: 1rem;position: absolute;"><svg
                                        ...
                                        fill="currentColor" viewBox="0 0 16 16" class="bi bi-alphabet-uppercase"
                                        style="border-color: #ad3324;color:#ad3324;">
                                        <path
                        ...
                        <div class="card shadow-sm" style="background-color: #0c5894;">
                            <div class="card-body px-4 py-5 px-md-5">
                                <div class="bs-icon-lg d-flex justify-content-center align-items-center mb-3 bs-icon"
                                    style="top: 1rem;right: 1rem;position: absolute;"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                        fill="currentColor" viewBox="0 0 16 16" class="bi bi-opencollective"
                                        style="border-color: #ad3324;color:#ad3324;">
                                        <path fill-opacity=".4"
                                ...
                                <h5 class="fw-bold card-title">Progress Tracking</h5>
                                <p class=" card-text mb-4">Stay on top of your learning with real-time
                                    progress tracking. Keep an eye on your improvements with detailed progress updates.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card shadow-sm" style="background-color: #0c5894;">
                            <div class="card-body px-4 py-5 px-md-5">
                                <div class="bs-icon-lg d-flex justify-content-center align-items-center mb-3 bs-icon"
                                    style="top: 1rem;right: 1rem;position: absolute;"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                        fill="currentColor" viewBox="0 0 16 16" class="bi bi-patch-question-fill"
                                        style="border-color: #ad3324;color:#ad3324;">
                                        <path
                        ...
                        <div class="card shadow-sm" style="background-color: #0c5894;">
                            <div class="card-body px-4 py-5 px-md-5">
                                <div class="bs-icon-lg d-flex justify-content-center align-items-center mb-3 bs-icon"
                                    style="top: 1rem;right: 1rem;position: absolute;"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                        fill="currentColor" viewBox="0 0 16 16" class="bi bi-clipboard-fill"
                                        style="border-color: #ad3324;color:#ad3324;">
                ...
                <div class="col-md-6 col-xl-4">
                    <div>
                        <form class="p-3 p-xl-4" method="post">
                            ...
                            <div><button class="d-block w-100" type="submit"
                                    style="background-color: #0c5894">Send </button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="d-flex flex-wrap flex-md-column justify-content-md-start align-items-md-start h-100">
                        <div class="d-flex align-items-center p-3">
                            <div class="bs-icon-md bs-icon-circle bs-icon-primary shadow d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon bs-icon-md"
                                style="background: #ad3324;"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                    height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-telephone">
                                    <path
                        ...
                        <div class="d-flex align-items-center p-3">
                            <div class="bs-icon-md bs-icon-circle bs-icon-primary shadow d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon bs-icon-md"
                                style="background: #ad3324"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                    height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-envelope">
                                    <path
                        ...
                        <div class="d-flex align-items-center p-3">
                            <div class="bs-icon-md bs-icon-circle bs-icon-primary shadow d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon bs-icon-md"
                                style="background: #ad3324"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                    height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-pin">
                                    <path
