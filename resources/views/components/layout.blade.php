...
<body>
    <!-- navbar -->
    <nav class="navbar navbar-expand-md sticky-top" style="background-color: #eeeeee" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span
                    class="d-flex justify-content-center align-items-center me-2 bs-icon"
                    style="width: 100px;height: 100px;"><img src="assets/img/logo.png"
                        width="100%" height="100%"></span></a><button data-bs-toggle="collapse"
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                @guest
                    <a class="btn btn-primary shadow" role="button" href="/login"
                        style="background: #eeeeee; border-color: #eeeeee; margin-right: 5px; color: #1f5994; box-shadow: none!important;">Log in</a>
                    <a class="btn btn-primary shadow" role="button" href="/register"
                        style="background: #0c5894; border-color: #0c5894;">Sign up</a>
                @endguest
                @auth
        ...
        <div class="container py-4 py-lg-5">
            <div class="row justify-content-center">
                <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column">
                    <h3 class="fs-6 fw-bold">Features</h3>
                ...
                <div
                    ...
                    <div class="fw-bold d-flex align-items-center mb-2"><span>UMYLINGO</span></div>
                    <p class="">We are here to assist you in learning a language in a fun and meaningful way.
                    </p>
                </div>
            </div>
            <hr>
