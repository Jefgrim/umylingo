<div class="deck-view-page">
    <div class="deck-view-header">
        ...
        <form>
            <select wire:model.change="selectedLanguage">
    ...
    <div class="deck-view-grid">
        ...
        <div class="deck-view-card" wire:key="{{ $learnProgress->deck->id }}">
            ...
            <div class="deck-view-actions">
                ...
                <a href="/deck/{{ $learnProgress->id }}/learn" wire:navigate class="btn btn-primary">Review</a>
                @elseif($learnProgress->isStarted && !$learnProgress->isCompleted)
                <a href="/deck/{{ $learnProgress->id }}/learn" wire:navigate class="btn btn-primary">Continue
                    Learning</a>
                @elseif(!$learnProgress->isStarted && !$learnProgress->isCompleted)
                <a href="/deck/{{ $learnProgress->id }}/learn" wire:navigate class="btn btn-primary">Learn</a>
                @endif

                @if ($learnProgress->isCompleted)
                @if (!$learnProgress->quizProgress->isCompleted && !$learnProgress->quizProgress->isStarted)
                <a href="/deck/{{ $learnProgress->quizProgress->id }}/quiz" wire:navigate class="btn btn-primary">Start
                    Quiz</a>
                ...
                <a href="/deck/{{ $learnProgress->quizProgress->id }}/quiz" wire:navigate
                    ...
                    Quiz</a>
                @elseif($learnProgress->quizProgress->isStarted && $learnProgress->quizProgress->isCompleted)
                <a href="/deck/{{ $learnProgress->quizProgress->id }}/quiz" wire:navigate class="btn btn-primary">Review
                    Quiz</a>
                @endif
                @endif
            </div>
