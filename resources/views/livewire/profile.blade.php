            ...
            <form wire:submit.prevent='updateProfile'>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="password" id="profile-current-password" wire:model="current_password" placeholder="Enter current password" required>
                    ...
                    @if(auth()->user()?->two_factor_confirmed_at)
                        <div class="form-group">
                            <label for="profile-twofactor-code">Authenticator Code</label>
                            <input type="text" id="profile-twofactor-code" wire:model="two_factor_code" inputmode="numeric" pattern="[0-9]*" placeholder="6-digit code">
                            @error('two_factor_code')
                                <span class="error-text">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            <label for="profile-recovery-code">Recovery Code</label>
                            <input type="text" id="profile-recovery-code" wire:model="recovery_code" placeholder="Recovery code">
                            @error('recovery_code')
                                <span class="error-text">{{ $message }}</span>
                            @enderror
                        </div>
